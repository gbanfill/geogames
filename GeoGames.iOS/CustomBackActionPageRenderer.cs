...
[assembly: ExportRenderer(typeof(CustomBackActionPage), typeof(CustomBackActionPageRenderer))]
namespace GeoGames.iOS
{
    public class CustomBackActionPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            base.ViewWillAppear(animated);

            if (((CustomBackActionPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((CustomBackActionPage)Element)?.CustomBackButtonAction != null)
                {
                    ((CustomBackActionPage)Element)?.CustomBackButtonAction.Invoke();
                }
            };
